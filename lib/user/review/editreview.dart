...
class _ReviewEditPageState extends State<ReviewEditPage> {
  ...
  void fetchReviewData() async {
    ...
    if (reviewSnapshot.exists) {
      ...
      setState(() {
        ...
        _existingPhotoUrls = List<String>.from(data?['photoUrls'] ?? []);
      });
    }
  }
  ...
  void _showFullNetworkImageDialog(String photoUrl) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
  ...
  Widget _buildNetworkPhotoPreview(String photoUrl) {
    return Stack(
      children: [
        GestureDetector(
          onTap: () {
            _showFullNetworkImageDialog(photoUrl);
          },
          child: Container(
            margin: EdgeInsets.all(4),
            decoration: BoxDecoration(
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    maxLines: 4,
                    maxLength: 300, // Set max length to 300 characters
                  ),
                  SizedBox(height: 20),
                  Center(
                  ...
                  GridView.count(
                    ...
                    children: _existingPhotoUrls
                        .map((photoUrl) => _buildNetworkPhotoPreview(photoUrl))
                        .toList()
                      ..addAll(_selectedPhotos
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              child:
                  Text('Update Review', style: TextStyle(color: Colors.white)),
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFF7472E0), // Button color
                shape: RoundedRectangleBorder(
